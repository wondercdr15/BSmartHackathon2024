...
export const canisterId = process.env.CANISTER_ID_WEBPAGE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./webpage.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the webpage canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./webpage.did.js")._SERVICE>}
 */
